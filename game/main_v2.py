...
class ZGame(QWidget):
    ...
    def __init__(self):
        ...
        self.thread_control = ThreadControl(self.zmap.data, self.tanks, self.tank_player, self.signal_update)
    ...
    def paintEvent(self, e):
        ...
        for bullet in self.thread_control.bullets:
    ...
    def keyPressEvent(self, e):
        if e.key() == 16777235: #up
            ...
            if bullet is not None:
                self.thread_control.bullets.append(bullet)
            else:
